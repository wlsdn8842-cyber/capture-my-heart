const CACHE='cmh-core-v0.5.3';
const CORE=['./','index.html','styles.css','config.js','ads.js','feedback.js','game.js','manifest.webmanifest','assets/images/title.webp','assets/audio/main.mp3'];
